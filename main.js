function bmiPromptImperial() {
  ...
  if (finalBmiImp < 18.5) {
    alert("Your BMI is " + round(finalBmiImp, 1) + ", this indicates you are underweight.");
  }
  if (finalBmiImp >= 18.5 && finalBmiImp <= 24.9) {
    alert("Your BMI is " + round(finalBmiImp, 1) + ", this indicates you are of normal weight.");
  }
  if (finalBmiImp >= 25 && finalBmiImp <=29.9) {
    alert("Your BMI is " + round(finalBmiImp, 1) + ", this indicates you are overweight.");
  }
  if (finalBmiImp >= 30) {
...
function bmiPromptMetric() {
  ...
  if (finalBmiMet < 18.5) {
    alert("Your BMI is " + round(finalBmiMet, 1) + ", this indicates you are underweight.");
  }
  if (finalBmiMet >= 18.5 && finalBmiMet <= 24.9) {
    alert("Your BMI is " + round(finalBmiMet, 1) + ", this indicates you are of normal weight.");
  }
  if (finalBmiMet >= 25 && finalBmiMet <=29.9) {
    alert("Your BMI is " + round(finalBmiMet, 1) + ", this indicates you are overweight.");
  }
  if (finalBmiMet >= 30) {
