...
function bmiPromptMetric() {
  ...
  if (finalBmiMet < 18.5) {
    alert("Your BMI is ${finalBmiMet.toFixed(1)}, this indicates you are underweight.");
  }
  if (finalBmiMet >= 18.5 && finalBmiMet <= 24.9) {
    alert("Your BMI is ${finalBmiMet.toFixed(1)}, this indicates you are of normal weight.");
  }
  if (finalBmiMet >= 25) {
    alert("Your BMI is ${finalBmiMet.toFixed(1)}, this indicates you are overweight.");
  }
}
